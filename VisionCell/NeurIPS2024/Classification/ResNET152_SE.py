...
class CustomResNet152SE(nn.Module):

    def __init__(self, num_classes=1000):
        super(CustomResNet152SE, self).__init__()
        self.inplanes = 64
...
if __name__ == "__main__":
    ...
    # Initialize our custom ResNet152
    model = CustomResNet152SE(num_classes=num_classes)  # Our custom class already allows setting the number of classes
    ...
    log_filename = f"ResNET152_Cell_Moss_SE_{run_timestamp}.txt"
    ...
    best_model_name = f"trained_resnet152_Moss_SE_BestModel_{run_timestamp}.pth"
    ...
    plot_loss(epochs, train_loss_list, val_loss_list, 'Loss', 'Epoch', f'ResNET152_Moss_SE_training_validation_loss_{run_timestamp}.png')

    plot_all_metrics(epochs, accuracy_list, f1_list, specificity_list, precision_list, recall_list, "Performance Over Epochs", f'ResNET152_Moss_SE_all_metrics_{run_timestamp}.png')
    ...
    for metric, metric_name in zip(metrics_for_comparison, metric_names_for_comparison):
        plot_metrics_vs_f1(metric, f1_list, metric_name,
                           f'{metric_name} vs F1-Score', f'ResNET152_Moss_SE_{metric_name}_Vs_F1-Score_{run_timestamp}.png')
